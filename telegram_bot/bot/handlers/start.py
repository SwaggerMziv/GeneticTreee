    ...
    if len(args) > 1:
        ...
        try:
            ...
            await message.answer(
                ...
                f"Я помогу сохранить ваши воспоминания в семейном архиве.\n\n"
                f"*Как это работает:*\n"
                f"1. Отвечаете на 3+ вопроса (текстом или голосом)\n"
                f"2. Нажимаете «Создать историю»\n"
                f"3. Проверяете и сохраняете результат\n\n"
                f"Чем подробнее ответы — тем лучше история.\n"
                f"Имена, места, даты, детали — всё важно.\n\n"
                f"Готовы? Нажмите *«Начать интервью»*",
